 ...
 * Pineapple class
 *
 * This class creates object instances of Pineapple.
...
public class Pineapple extends Fruit {
     ...
     */
    private final double ACCEL_FACTOR = 0.08; // the maximum amount this fruit will move in either direction

    /**
     * constant int of the width of Pineapple
     */
    private final int FRUIT_WIDTH = 120;

    /**
     * constant int of the height of Pineapple
     */
    private final int FRUIT_HEIGHT = 120;
     ...
     */
    public Pineapple(Game app, String imgFilePath, int x, int y) {
     ...
     *
     * this method controls the fall of the Pineapple object
     */
    public void fall() {
